...
interface CategoriesTableContextProps {
	...
	setCategories: React.Dispatch<React.SetStateAction<TProductCategory[]>>
}
...
export function ProductCategoriesTableProvider({ children }: React.PropsWithChildren) {
	const [featureFlags, setFeatureFlags] = React.useState<FeatureFlagValue[]>([])
	const [categories, setCategories] = React.useState<TProductCategory[]>([])
