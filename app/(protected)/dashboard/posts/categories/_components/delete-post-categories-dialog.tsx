...
import {deletePostCategories, deletePostCategory} from "@/actions/posts/categories/actions";
...
interface DeleteCategoriesDialogProps
	...
	records: Row<TPostCategoryWithPostCount>["original"][]
	showTrigger?: boolean
	onSuccess?: () => void
}
					...
					<Button
						...
						onClick={() => {
							startDeleteTransition(async () => {
								const { error } = await deletePostCategories({
